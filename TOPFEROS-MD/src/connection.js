...
async function requestPairingCode(
  ...
  // ----------------------------------------------------------
  // DO NOT LOAD AUTH STATE AGAIN HERE
  // ----------------------------------------------------------

  // createSocket() already loaded the
